...
CREATE INDEX idx_exchange_rates_pair ON public.currency_exchange_rates (base_currency, target_currency, effective_at);

INSERT INTO public.currency_exchange_rates (base_currency, target_currency, rate, effective_at) VALUES
